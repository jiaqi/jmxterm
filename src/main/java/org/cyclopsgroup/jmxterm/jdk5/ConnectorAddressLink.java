...
public interface ConnectorAddressLink {
   ...
   * 
   * @param vmid an identifier that uniquely identifies a local Java virtual machine, or
   *        <code>0</code> to indicate the current Java virtual machine.
   * @return the value of the connector address, or <code>null</code> if the target VM has not
   *         exported a connector address.
