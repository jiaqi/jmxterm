...
```
jiaqi@happycow:~$ java -jar jmxterm-1.0.2-uber.jar -h
...
* Interactive console — without any option, it opens an interactive
  command-line console.
* File interpreter — with `-i` option, it processes a given script
  file and exits at the end.
...
```
jiaqi@rattlesnake:~$ java -jar jmxterm-1.0.2-uber.jar
